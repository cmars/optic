...
<PreviewPageModal Source={<Tasks />} title='Optic.yml - Tasks' link={'/reference/optic-yaml/tasks'}>
...
<PreviewPageModal Source={<Environments />} title='Optic.yml - Environments' link={'/reference/optic-yaml/environments'}>
  <Button color="primary" variant="contained">
...
<PreviewPageModal Source={<Scripts />} title='Optic.yml - Scripts' link={'/reference/optic-yaml/scripts'}>
  <Button color="primary" variant="contained">
