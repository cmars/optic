...
import {CommonLinks} from '../../../src/components/Modal'
...
Expand LINK to HOW TO BASELINE
...
3. Open Optic's UI. *shorthand* `api status --review`
4. Optic will suggest possible changes to the API spec, all you have to do is `Approve` them:

[GIF: SHOW A CHANGE AND APPROVING IT]
