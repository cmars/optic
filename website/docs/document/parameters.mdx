...
If you have already staged your endpoint to be committed, you'll need to unstage it first by discarding what Optic has learned. Don't worry, you'll be able to learn it again just as quickly as before, and this time with the correct path parameter.
...
It's easy to consolidate all of the traffic to a given endpoint. This helps make documenting quick and easy. Did you know that it's also possible to document all of your endpoints in bulk? Read on to see how to [bulk learn](/document/bulk-learn) all of your unmatched endpoints!
