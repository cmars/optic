...
> Get visibility into how your API works today, Optic will learn the API's current behavior by observing traffic. Then it will help you quickly write an accurate specification.
