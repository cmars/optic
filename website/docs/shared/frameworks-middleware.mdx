...
<>The latest instructions for integrating the <a href={props.sdk_url}>{props.title} Middleware</a> with your project are kept alongside the Middleware itself in a <a href={props.sdk_readme}>README.md</a>. Once you've integrated the Middleware, the next step is to connect your project with Optic.</>
